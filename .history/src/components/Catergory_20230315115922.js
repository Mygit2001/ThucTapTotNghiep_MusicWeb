  ...
  return (
    <div className="mt-12 px-[59px] mb-20">
      ...
      <div className="flex items-center gap-4 text-md font-semibold mb-5">
        <button
          type="button"
          className= {`py-1 px-4 rounded-l-full text-orange-300 cursor-pointer rounded-r-full border border-purple-500 ${isActive ===0 && 'bg-gray'}`}
        ...
        <button
          type="button"
          className={`py-1 px-4 rounded-l-full cursor-pointer text-orange-300 rounded-r-full border border-purple-500 ${isActive ===1 && 'bg-gray'}`}
