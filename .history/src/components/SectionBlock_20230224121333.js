  ...
  return (
    <div className="mt-12 px-[59px] flex flex-col gap-5 mb-20">
      <div className="flex items-center justify-between">
        ...
        <span className="text-md font-semibold text-blue-700 cursor-pointer hover:text-blue-900">
          Tất cả
        </span>
      </div>
              ...
              >
                <img
                  ...
                  className={`w-full h-auto rounded-full ${
                    isHover && "animate-scale-image"
                  }`}
                />
                {isHover && (
                  <div className="absolute top-0 right-0 left-0 bottom-0 bg-transparent-05 rounded-md"></div>
                )}
