    ...
    <div className="bg-emerald-300 px-5 h-full flex z-50 border-t-1 border-t-orange-400">
      ...
      <div className="w-[30%] flex-auto text-center flex items-center justify-end">
        ...
        >
          ...
          {!isHoverVolume 
          ? <div className="w-[130px] h-[4px] bg-gray-200 flex-none  rounded-r-full rounded-l-full relative">
            <div className="absolute left-0 right-1/2 top-0 bottom-0 bg-orange-500 rounded-r-full rounded-l-full"></div>
          </div> : 
          <input
            type="range"
            max={100}
