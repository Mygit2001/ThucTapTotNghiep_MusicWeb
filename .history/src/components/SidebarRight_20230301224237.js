    ...
    return (
        <div className='flex flex-col text-xs w-full'>
            <div className='h-[70px] flex-none py-[14px] px-2 flex items-center justify-between gap-8'>
                <div className=' font-semibold flex flex-auto justify-center bg-emerald-300 rounded-l-full rounded-r-full py-[6px] px-[6px]'>
                    <span className='py-[5px] flex-1 bg-[#f97316] flex items-center justify-center rounded-r-full rounded-l-full'>Gần đây</span>
                    <span className='py-[5px] flex-1 bg-[#fb923c] flex items-center justify-center rounded-r-full rounded-l-full'>Danh sách phát</span>
                </div>
