         ...
         >
            <div className="flex gap-4 ">
                ...
                <div className="flex flex-col font-semibold">
                    <span className='text-base text-red-900 mb-1'>{title.lenght > 30 ? `${title.slice(0, 30)}...` : title}</span>
                    <span className='text-xs text-red-700'>{artistsName.lenght > 30 ? `${artistsName.slice(0, 30)}...` : artistsName}</span>
                </div>
            </div>
        </div>
     );
