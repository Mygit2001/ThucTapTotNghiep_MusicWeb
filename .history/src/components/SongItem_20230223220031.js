...
const SongItem = ({thumbnail, title, artistsName, sid, style, size}) => {
    ...
    return ( 
        <div 
         className = 'w-[30%] flex flex-auto border-double border-1 border-purple-400 rounded-md shadow-xl p-[10px] items-center gap-[12px] hover:bg-gray-300 cursor-pointer'
         onClick={() => {
