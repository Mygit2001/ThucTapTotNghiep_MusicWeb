...
const Player = () => {
  ...
  return (
    <div className="bg-emerald-300 px-5 h-full flex z-50 border-t-1 border-t-orange-400">
      ...
      <div className="w-[30%] hidden flex-auto text-center min-[640px] flex items-center justify-end">
        <div 
        ...
        >
          ...
          <div className={`w-[130px] h-1 bg-gray-200 flex-none  rounded-r-full rounded-l-full ${isHoverVolume ? 'hidden' : 'relative'}`}>
