...
const SongItem = ({thumbnail, title, artistsName, sid, style, size}) => {
    ...
    return ( 
        <div 
         className = {`${style || 'w-full flex border-double border-1 border-purple-400 rounded-md shadow-xl p-[10px] items-center gap-[12px]  cursor-pointer hover:bg-gray-300 '}`}
         onClick={() => {
