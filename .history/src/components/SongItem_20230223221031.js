...
const SongItem = ({thumbnail, title, artistsName, sid, style, size}) => {
    ...
    return ( 
        <div 
         className = {`flex border-double border-1 border-purple-400 rounded-md shadow-xl p-[10px] items-center gap-[12px]  cursor-pointer ${style || 'hover:bg-gray-300 w-full'}`}
         onClick={() => {
