            ...
            ?.map((item) => (
              <div key={item.encodeId} className="flex-1">
                <SongItem
                  ...
                  size="w-[80px] h-[80px]"
                  style= 'w-full flex border-double border-1 border-purple-400 rounded-md shadow-xl p-[10px] items-center justify-c gap-[12px]  cursor-pointer hover:bg-gray-300'
                />
              </div>
            ))}
        </div>
