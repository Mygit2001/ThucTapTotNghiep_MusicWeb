    ...
    <div className="w-full flex flex-col items-center justify-center">
      <div className="bg-gradient-to-r from-cyan-400 to-blue-400 w-[600px] p-[30px] pb-[100px] rounded-md shadow-md">
        ...
        <div className="flex items-center justify-between mt-5">
            <small className="text-blue text- cursor-pointer hover:text-red-700">Quên mật khẩu</small>
            <small className="text-blue text- cursor-pointer hover:text-red-700">Đăng kí</small>
        </div>
      </div>
    </div>
  );
