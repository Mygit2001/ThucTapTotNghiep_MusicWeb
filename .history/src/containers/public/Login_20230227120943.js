    ...
    <div className="w-full flex flex-col items-center justify-center">
      <div className="bg-gradient-to-r from-cyan-400 to-blue-400 w-[600px] p-[30px] pb-[100px] rounded-md shadow-md">
        ...
        <div className="w-full flex flex-col gap-5">
          ...
          <button
            type="button"
            className="w-full outline-none rounded-md hover:text-blue-500 hover:bg-blue-500  flex items-center justify-center gap-1 bg-blue-600 text-white py-2 text-lg"
          >
            Đăng nhập
          </button>
        </div>
