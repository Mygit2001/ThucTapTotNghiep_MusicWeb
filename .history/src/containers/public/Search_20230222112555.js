    ...
    <div>
      <div className="h-[50px] mb-7 items-center py-1 pl-[60px]">
        ...
        <div className="flex items-center gap-6 font-semibold mt-6 border-b text-red-600">
          <span className="pr-4 py-3 hover:text-purple-500">Tất cả</span>
          <span className="px-4 py-3 hover:text-purple-500">Bài hát</span>
          <span className="px-4 py-3 hover:text-purple-500">Album</span>
        </div>
      </div>
      <div>
        <Outlet />
