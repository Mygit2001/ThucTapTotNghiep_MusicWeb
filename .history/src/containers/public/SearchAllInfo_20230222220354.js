...
const SearchAllInfo = () => {
  ...
  return (
    <div className="w-full flex flex-col px-[60px] pb-[30px]">
      ...
      <div className="flex flex-col mt-6">
        <h3 className="text-lg font-semibold text-red-600 mb-3">Bài hát nổi bật</h3>
          <div className="flex justify-between flex-wrap w-full">
            {searchData?.songs?.map(item => (
              <div key={item.encodeId} className="flex-auto w-[45%] p-2 border-top-width-medium border-double border-1 border-purple-400
